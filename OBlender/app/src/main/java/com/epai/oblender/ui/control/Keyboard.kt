...
package com.epai.oblender.ui.control
...
fun GamepadSpecialArea(
    ...
    LazyColumn(
        ...
        //单次鼠标滚轮上
        item {
            val selected = remember(refreshed) { isSelected("SPECIAL_KEY_MOUSE_SCROLL_LEFT") }
            InfoLayoutTextItem(
                modifier = Modifier.fillMaxWidth(),
                title = stringResource(R.string.control_editor_edit_event_launcher_mouse_scroll_up_single),
                onClick = {
                    onTap("SPECIAL_KEY_MOUSE_SCROLL_LEFT")
                },
                showArrow = false,
                selected = selected
            )
        ...
        //单次鼠标滚轮下
        item {
            val selected = remember(refreshed) { isSelected("SPECIAL_KEY_MOUSE_SCROLL_RIGHT") }
            InfoLayoutTextItem(
                modifier = Modifier.fillMaxWidth(),
                title = stringResource(R.string.control_editor_edit_event_launcher_mouse_scroll_down_single),
                onClick = {
                    onTap("SPECIAL_KEY_MOUSE_SCROLL_RIGHT")
                },
                showArrow = false,
                selected = selected
            )
